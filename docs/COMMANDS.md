...
Inkwell provides a number of commands you may use to quickly navigate and edit your projects. Those marked as “requires editing” below require you to be actively editing a scene in your project.

| Name                                          | Requires Editing | Description                                                                                                                             |
| --------------------------------------------- | ---------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| Open Current Note’s Project                   | true             | Selects your current project (or draft of project) in the Inkwell pane.                                                                |
...
| Jump to Project                               | false            | Fuzzy-matches against known project titles, then shows it in the Inkwell pane and switches to that pane.                               |
...
| Open Inkwell Pane                            | false            | Switches to the Inkwell pane.                                                                                                          |
